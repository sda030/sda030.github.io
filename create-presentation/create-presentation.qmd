...
- Metrics → stress: Funding and publication
...
- Job safety
- Incentives
  - Teach, publish articles, get NRC/EU funding
  - Invoice, publish articles, get any funding
- Salary and perks
...
- Sports: workout groups, bouldering, PT, football, running, pingpong, padel, interval runs, special events days
...
## Senior compared to junior
- Leading more projects/applications
- Fewer projects
- Much more free time, workout, life
- More side-projects/consultancy/etc
- Bit more advisory role
- Pickier on design, topic, etc.
...
- Reviewing measures of Norwegians' digital skills (KMD; q)
- Teachers' digital competences (USN; p)
- Questions to School-Norway (Udir; s)
- Merger at University College Vestlandet (HVL; s)
- RCT of a marketing learning game (RFF; p)
- RCT on extra teacher (RCN; p)
- ++ many smaller tasks
- Finishing PhD/defence/awards/etc in spare time

## Senior: 2026
- Revising the higher vocational student survey (HK-dir; p)
...
- Measuring executives' room to maneuver (p)
- RCT on teacher PD (RCN proposal; p)
- +++ Backlog of articles, Saros, etc
...
- Knew 2 former colleagues there who mentioned the pros and cons
- The only relevant position available when I was searching and got it immediately...
